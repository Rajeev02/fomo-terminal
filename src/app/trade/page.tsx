...
function TradeContent() {
  ...
  const tokenAddress =
    searchParams.get("token") || "So11111111111111111111111111111111111111112";
          ...
          <div className="space-y-4">
            ...
            <div className="bg-zinc-950 border border-zinc-800 rounded-lg p-3">
              ...
              <div className="flex items-center justify-between">
                ...
                />
                <button className="bg-zinc-800 px-3 py-1 rounded-full font-bold">
                  {trendingTokens.find((t) => t.address === tokenAddress)
                    ?.symbol || "..."}
                </button>
              </div>
            </div>
...
export default function TradePage() {
  return (
    <Suspense
      fallback={
        <div className="p-8 text-center">Loading trading interface...</div>
      }
    >
      <TradeContent />
    </Suspense>
