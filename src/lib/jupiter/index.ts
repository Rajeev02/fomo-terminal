...
export class JupiterService {
   ...
   */
  static async getQuote(inputMint: string, outputMint: string, amount: number, slippageBps: number = 50) {
   ...
   */
  static async executeSwap(quoteResponse: any, userPublicKey: string) {
